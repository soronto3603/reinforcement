...
folder_path = './model_saves/MsPacmanv6/'
# weights_filename = '{}dqn_MsPacman-v6_weights.h5f'.format(folder_path)
# checkpoint_weights_filename = folder_path + 'dqn_MsPacman-v0_weights_{step}.h5f'
# log_filename = folder_path + 'dqn_MsPacman-v5_REWARD_DATA.txt'
# callbacks = [ModelIntervalCheckpoint(checkpoint_weights_filename, interval=100000)] 
# # callbacks += [TrainEpisodeLogger(log_filename)]
# dqn.fit(env, callbacks=callbacks, visualize=False ,nb_steps=1000000, verbose=2, nb_max_episode_steps=20000)

weights_filename = folder_path + 'final_noisynet_nstep_pdd_dqn_MsPacman-v0_weights_1100000.h5f'
