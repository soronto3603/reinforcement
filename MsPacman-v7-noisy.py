...
folder_path = './model_saves/MsPacmanv7/'
...
if args.mode == 'train':
    ...
    dqn.fit(env, callbacks=callbacks, nb_steps=100000000, verbose=2, nb_max_episode_steps=20000)


elif args.mode == 'test':
    weights_filename = folder_path + 'final_noisynet_nstep_pdd_dqn_MsPacman-v0_weights_2000000.h5f'
    if args.weights:
